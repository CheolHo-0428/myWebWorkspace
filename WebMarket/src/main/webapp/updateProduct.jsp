...
<body>
	...
	<% 
		...
		String sql = "select p_filename,p_id,p_name,p_unitPrice,p_description,p_category,p_manufacturer,p_unitsInStock from product where p_id = ?";
				...
				<div class = "row">
					<div class="col-md-5">
						<img src="./resources/images/<%=rs.getString("p_filename")%>" 
							alt="<%=rs.getString("p_filename")%>" width="100%">
					</div>
					<div class="col-md-7">
						<form name="newProduct" action="./processUpdateProduct.jsp" 
							...
							<div class="form-group row">
								...
								<div class="col-sm-5">
									<input type="radio" id="condition" name="condition" value="New ">
									신규 제품
									<input type="radio" id="condition" name="condition" value="Old ">
									중고 제품
									<input type="radio" id="condition" name="condition" value="Refurbished ">
									재생 제품
								</div>
							</div>
							<div class="form-group row">
